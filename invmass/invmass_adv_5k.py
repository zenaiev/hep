...
def generate_and_decay(parent_mass, daughter_masses):
  ...
  if len(daughter_masses) > 0:
    ...
    particles += two_body_decay(parent, daughter_mass_1, daughter_mass_2)
  else:
    particles = [parent]
  ...
  for particle in particles:
    smeared_particles.append(smear_momentum(particle))
