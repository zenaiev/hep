...
exit
	\end{minted}
		...
		{\scriptsize
			\begin{minted}{c++}
docker run -it --name my_od
		\end{minted}
		}
		\item Далі виконувати інструкції для Analyzer із \url{https://github.com/zenaiev/2011-doubleelectron-doublemu-mueg-ttbar} і запустити Analyzer для одного файлу з даними і МК
	\end{itemize}
\end{frame}
